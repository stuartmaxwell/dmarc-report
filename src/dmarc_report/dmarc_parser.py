...
class Report:
    ...
    def display(self) -> None:
        ...
        metadata_table.add_row("Org name", self.report_metadata.org_name)
        metadata_table.add_row("Email", self.report_metadata.email)
        metadata_table.add_row("Extra contact info", self.report_metadata.extra_contact_info)
        metadata_table.add_row("Report ID", self.report_metadata.report_id)
        metadata_table.add_row("Date range", str(self.report_metadata.date_range))
        ...
        policy_table.add_row("Percent", f"{self.policy_published.pct!s}%")
